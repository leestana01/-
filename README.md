# 제작 목적
H 고등학교 재학 중에, 방과후학교 신청 자동화를 목적으로 만든 프로그램

웹 페이지가 굳이 뜰 필요도 없이 자동적으로 신청을 완료하여

궁극적으로, **롤을 전체화면으로 띄워놓고 게임을 하는 와중에도** 자동으로 신청을 완료하는 것을 목표로 제작함.
...
- 백그라운드에서 exe 자체적으로 웹 브라우징하여 페이지의 모든 요소를 읽어 옴 -> 사용자에게 웹 브라우저를 표시하지 않기 위함
